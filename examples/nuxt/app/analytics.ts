...
//
// autoPageviews is off because this is a single-page app after hydration:
// the router knows what counts as a navigation, and the client's fallback
// (patching history.pushState) cannot see a replaceState, which routers use
// for redirects and search-parameter changes.
