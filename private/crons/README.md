...
- Ships a nightly sweep of entry revisions past the newest few an entry keeps (see [private/content](../content)), which is what bounds a table that otherwise grows with every edit.
